...
const int LEVEL1_BUTTON_POSX = 905;
const int LEVEL1_BUTTON_POSY = 605;
const int LEVEL2_BUTTON_POSX = 100;
const int LEVEL2_BUTTON_POSY = 100;
const int LEVEL3_BUTTON_POSX = 200;
const int LEVEL3_BUTTON_POSY = 200;
const int LEVEL4_BUTTON_POSX = 200;
const int LEVEL4_BUTTON_POSY = 300 ;
