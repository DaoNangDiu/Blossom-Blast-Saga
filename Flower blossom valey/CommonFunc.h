...
const int LEVEL2_BUTTON_POSX = 1150;
const int LEVEL2_BUTTON_POSY = 530;
const int LEVEL3_BUTTON_POSX = 950;
const int LEVEL3_BUTTON_POSY = 480;
const int LEVEL4_BUTTON_POSX = 200;
const int LEVEL4_BUTTON_POSY = 200 ;
